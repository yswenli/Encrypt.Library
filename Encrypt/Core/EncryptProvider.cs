...
namespace Encrypt.Library.Core
{
    public class EncryptProvider
    {
        ...
        */
        ...
        /// <param name="privateKey">private key</param>
        /// <returns></returns>
        public static byte[] RSASign(byte[] conent, string privateKey)
        {
            return RSASign(conent, privateKey, HashAlgorithmName.SHA256, RSASignaturePadding.Pkcs1, Encoding.UTF8);
        }
        ...
        public static byte[] RSASign(byte[] content, string privateKey, HashAlgorithmName hashAlgorithmName, RSASignaturePadding rSASignaturePadding, Encoding encoding)
        {
            Check.Argument.IsNotEmpty(content, nameof(content));
            Check.Argument.IsNotEmpty(privateKey, nameof(privateKey));
            Check.Argument.IsNotNull(rSASignaturePadding, nameof(rSASignaturePadding));
        ...
        {
            string encryptStr = RSAEncrypt(publicKey, data, RSAEncryptionPadding.OaepSHA512);
            return encryptStr;
        }
        ...
        {
            return RSAEncrypt(publicKey, data, RSAEncryptionPadding.OaepSHA512);
        }
        ...
        /// <returns></returns>
        /// <exception cref="OutofMaxlengthException"></exception>
        ...
        {
            return RSAEncrypt(publicKey, data, RSAEncryptionPadding.Pkcs1, true);
        }
        ...
        /// <returns></returns>
        public static byte[] Md5(byte[] data, MD5Length length = MD5Length.L32)
        {
            Check.Argument.IsNotEmpty(data, nameof(data));
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static string GetMd5Str(byte[] data, MD5Length length = MD5Length.L32)
        {
            Check.Argument.IsNotEmpty(data, nameof(data));
